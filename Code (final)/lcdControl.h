 ...
 * * * * * * * */
	 ...
	 * Summary:
	 * --------
	 * 		displays the time in the left top corner of the lcd
	 ...
	 * Summary:
	 * --------
	 * 		'NewTime-state-layout' * is written to the display (after the screen is first cleared)
     * 
     *      * ----------------------------
     *       |New time set for:           |
     *       |                            |
	 ...
	 * -------
     *      char* str:
     *          character array (~string) representing a certain melody
	 * Summary:
	 * --------
	 ...
	 * -------
	 * 		char* str:
	 * 			character array (~string) representing the current menu item
	 * 		int hours:
	 * 		    integer representing the hours of a certain time
     *      int minutes:
     *          integer representing the minutes of a certain time
	 ...
	 * -------
	 * 		int onOff:
	 * 			integer representing the state of the alarm:
	 * 				0 -> alarm is off
	 * 				1 -> alarm is on
	 * 
	 * Summary:
	 * --------
	 * 		the function writes "on" or "off" to the top right corner of the display 
	 */
	void display_alarm_onOff(int onOff);

	/*
	 * Function: display_date_lefetbottom
	 * -----------------
	 * Parameters:
	 * -------
	 * 		char* weekday:
	 * 			character array (~string) representing the day of the week
	 * 		int day:
	 * 		    integer representing the day of a month
     *      char* month:
     *          character array (~string) representing the month
     *      int year:
     *          integer representing the current year
	 * Summary:
	 * --------
	 * 		the date is written to the left bottom corner of the screen
	 * 			f.ex.: weekday = "Mon", day = 5, month = "Jan", year = 2019
	 * 				=> Mon 5 Jan 2019		   
	 */
	 ...
	 * -------
	 * 		int d:
	 * 		    integer representing the current day of the month
     *      int m:
     ...
     * 		the integer representing the month is automatically converterted to a character array for the month
	 * 
	 * 			f.ex.: d = 11, m = 11, y = 2019
     *      * ----------------------------
     *       |New date set for:           |
     *       |                            |
     *       |       11 dec 2019          |
