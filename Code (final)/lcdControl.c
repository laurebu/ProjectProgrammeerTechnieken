 ...
 *              contains:
 *                  constant array containing the font of the letters for the lcd
 *                  methods to put characters, strings, int on the lcd
 *                  methods to display certain menus/layouts on the lcd 
 *                  methods to get the name of a month based on the number of a month
 *                  methods to get the length of a string
 */
